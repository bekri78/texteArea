    ...
    <Col xs={12} sm={12} md={6} lg={4}>
      <Card className={classes.root}>
        <CardHeader
          ...
          title={props.name}
          subheader={props.adresse}
        />
        <CardMedia className={classes.media} image={img} title="Paella dish" />

        <Etoile etoile={props.etoile} />
        <Typography variant="body2" color="textSecondary" style={{ padding: '10px' }} component="p">
